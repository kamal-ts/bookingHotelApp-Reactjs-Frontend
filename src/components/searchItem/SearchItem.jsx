...
const SearchItem = ({ idImg }) => {
    return (
        <div className='relative flex flex-col lg:flex-row p-3 border border-slate-300 hover:border-sky-400 rounded-3xl mb-5 gap-3 justify-between transition-all hover:bg-sky-50 hover:shadow-lg '>
            ...
            <div className='flex flex-col text-sm justify-between flex-auto'>
                <h1 className='text-2xl font-bold text-slate-800'>Tower Street Apartments</h1>
                <span>500m from center</span>
                <span className='bg-green-600 text-white self-start px-1 rounded-md'>Free.airport taxi</span>
            ...
            <div className='flex flex-col justify-between w-full lg:w-36'>
                ...
                <div className='text-end'>
                    ...
                    <button className='mt-3 w-full py-2 rounded-3xl font-bold bg-sky-400 text-slate-800 text-base transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300'>See avilability</button>
                </div>
            </div>
